...
public sealed class CadesLongTermEvidence
{
    public CadesLongTermEvidence(
        ...
        IEnumerable<byte[]>? certificateRevocationLists = null)
    {
        ...
        {
            throw new ArgumentException("CAdES B-LT requires at least one certificate.", nameof(certificates));
        }
